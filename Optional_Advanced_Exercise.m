...
% wordir is your own work dictionary address
wordir = 'F:\FBSP_Matlab\Advanced_OPTIONAL_Exercise\';
% subj_code_addr is your own subj_codes.cvs address
subj_code_addr = 'F:\FBSP_Matlab\Advanced_OPTIONAL_Exercise\logs\subj_codes.csv';
% logfile_addr is your own log file address
...
for jj = 1:40
    cur_dir = [logfile_addr '\' fileNames{jj}];
